  ...
  return (
    <div className="min-h-screen bg-background text-white selection:bg-emerald-500/30">
      ...
      <div className={`transition-all duration-300 ${sidebarOpen ? 'lg:ml-64' : 'lg:ml-20'}`}>
        ...
        {/* Footer */}
        <footer className="border-t border-white/5 px-4 sm:px-6 lg:px-8 py-10 sm:py-12 bg-card/30">
          ...
          <div className="mt-10 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-muted-foreground/30 text-[10px] text-center sm:text-left font-bold uppercase tracking-widest">© 2026 B50 Trade Strategic Group • All Rights Reserved</p>
